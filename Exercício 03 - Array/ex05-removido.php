    ...
    <body>
        ...
        <main class="col-12 d-flex justify-content-center">
            <div class="fluid-container col-12 col-md-6 d-flex justify-content-center align-content-center flex-column">
                ...
                <p>- Crie um array com os números de 1 a 5. Remova o terceiro elemento do array e exiba o array resultante. Dica: Use a função unset() para remover um elemento específico do array.</p>
                ...
                <?php
                    ...
                    unset($numeros[2]);
                    echo 'sem o terceiro valor resulta em: ';
                    foreach($numeros as $value) {
                        echo $value.' ';
                    }
                ?>
