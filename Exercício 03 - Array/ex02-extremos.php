    ...
    <body>
        ...
        <main class="col-12 d-flex justify-content-center">
            <div class="fluid-container col-12 col-md-6 d-flex justify-content-center align-content-center flex-column">
                ...
                <p>- Crie um array unidimensional com 10 números inteiros. Encontre e exiba o menor e o maior número do array.</p>
                ...
                <?php
                    ...
                    echo' tem mínimo de: '.min($numeros).' e máximo de: '.max($numeros);
                ?>
            </div>
        </main>
        <footer>
