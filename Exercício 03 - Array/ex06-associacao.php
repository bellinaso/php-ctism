    ...
    <body>
        ...
        <main class="col-12 d-flex justify-content-center">
            <div class="fluid-container col-12 col-md-6 d-flex justify-content-center align-content-center flex-column">
                ...
                <h2 class="text-center">Exercício 6 - Array associativo</h2>
                <p>- Crie um array associativo que contenha o nome e a idade de cinco pessoas. Escreva um script que exiba a idade de uma pessoa específica, dada pelo nome. Use o nome como chave para acessar a idade no array associativo.</p>

                <hr>

                <?php
                    $pessoas = array('Fulano' => 37,
                                    'Ciclano' => 23,
                                    'Beltrano' => 44,
                                    'Moicano' => 52);
